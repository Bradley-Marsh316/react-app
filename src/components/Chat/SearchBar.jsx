...
export default function SearchBar() {
  return (
    <div className="flex items-center w-full h-14 shadow-sm">
      <input type="text" className="h-full flex w-2/3 rounded-l-md focus:outline-none px-8" style={{ 'margin-right': '2px' }} />
